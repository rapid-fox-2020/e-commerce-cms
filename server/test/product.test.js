...
describe("CRUD /products", () => {
  ...
  let productGlobal = {
    ...
    name: "namaProduct",
    imageUrl:
      "https://ecs7.tokopedia.net/img/cache/700/product-1/2018/6/21/3029860/3029860_bba695f5-bf14-4f11-bfef-63be5afe7b05_700_700.jpg",
    stock: 20,
    price: 10000,
  };
    ...
    it("update products by id response (200)", (done) => {
      request(app)
        ...
        .then((response) => {
          ...
          expect(body).toHaveProperty("imageUrl", updatedProduct.imageUrl);
