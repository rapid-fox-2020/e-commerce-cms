...
describe('Test products',()=>{
  ...
  describe('Test Route POST/ products', () => {
    ...
    test('response(201) success create Data - return created product data', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju lapis",image_url:"www.pinterest.com",price:100000,stock:20}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for Name', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"",image_url:"www.pinterest.com",price:100000,stock:20}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for Image_URL', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju baju",image_url:"",price:100000,stock:20}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for price(in number format)', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju baju",image_url:"www.google.com",price:5000,stock:20}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for price(in string format)', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju baju",image_url:"www.google.com",price:"price",stock:20}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for stock (in number format)', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju baju",image_url:"www.google.com",price:100000,stock:0}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
    ...
    test('response(400) failed Create Data - return validation for stock(in string format)', (done) => {
      const accessToken = getAccessToken
      const addProduct = {name:"Baju baju",image_url:"www.google.com",price:100000,stock:"stock"}
      request(app)
      .post('/products')
      .set({token:accessToken,Accept:'application/json'})
      .send(addProduct)
  ...
  describe('Test Route PUT/products/:id', () => {
    test('response(200) success update Data - return new updated product data', (done) => {
      const accessToken = getAccessToken
      const updateProduct = {name:"Baju saja",image_url:"www.blabla.com",price:100000,stock:10}
      request(app)
      .put(`/products/${itemId}`)
      .set({token:accessToken,Accept:'application/json'})
      .send(updateProduct)
