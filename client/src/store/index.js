  ...
  actions: {
    login(context) {
      return new Promise((resolve, reject) => {
        axios({
          method: 'post',
          url: 'https://my-e-commerce-02.herokuapp.com/login',
          data: {
    ...
    getProducts(context) {
      axios({
        method: 'get',
        url: 'https://my-e-commerce-02.herokuapp.com/products',
        headers: {
    ...
    getProductById(context, payload) {
      axios({
        method: 'get',
        url: `https://my-e-commerce-02.herokuapp.com/products/${payload}`,
        headers: {
          token: localStorage.accessToken,
        },
      })
    ...
    getBannerById(context, payload) {
      axios({
        method: 'get',
        url: `https://my-e-commerce-02.herokuapp.com/banners/${payload}`,
        headers: {
          token: localStorage.accessToken,
        },
      })
    ...
    editProduct(context) {
      return new Promise((resolve, reject) => {
        axios({
          method: 'put',
          url: `https://my-e-commerce-02.herokuapp.com/products/${this.state.id}`,
          headers: {
            token: localStorage.accessToken,
          },
          data: {
    ...
    editBanner(context) {
      return new Promise((resolve, reject) => {
        axios({
          method: 'put',
          url: `https://my-e-commerce-02.herokuapp.com/banners/${this.state.banner_id}`,
          headers: {
            token: localStorage.accessToken,
          },
          data: {
